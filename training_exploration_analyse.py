...
def run_and_save_PDE_trajectory():
	...
	vis = NCA_Visualiser([ca])
	#vis.save_image_sequence(np.array(trajectory[...,:1]),"figures/heat_eq_NCA/")
	vis.save_image_sequence(np.array(trajectory_true),"figures/heat_eq_PDE/")
	#vis.save_image_sequence(traj_diff,"figures/heat_eq_ERR/")
#run_PDE_models()
plot_training_error()
