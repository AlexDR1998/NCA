...
OPTIMIZER="Nadam"
TRAIN_MODE="full"
LOSS_FUNC,LOSS_FUNC_STRING,TASK,LAYERS,KERNEL_TYPE,ACTIVATION = index_to_model_exploration_parameters_spectral(index)
PDE_SAMPLING = 8
EMOJI_SAMPLING = 64
...
if TASK=="heat":
    ...
    x0[3,16:24,40:48]=1
    x0[3,40:48,16:24]=1
    trainer = NCA_PDE_Trainer(ca_heat, x0, F_heat, N_BATCHES, T=PDE_STEPS, step_mul=PDE_SAMPLING, model_filename=FILENAME)
