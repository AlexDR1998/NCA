...
def adhesion_mask_batch(data):
  ...
  print(mask0.shape)
  masks = np.repeat(mask0[np.newaxis],N_BATCHES,axis=0)#np.zeros((N_BATCHES,mask0.shape[0],mask0.shape[1]))
  print(masks.shape)
